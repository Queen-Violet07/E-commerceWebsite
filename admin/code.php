...
else if(isset($_POST['update_category_btn']))
{
    ...
    {
        redirect("edit_category.php?id=$category_id", "Somethin Went Wrong!");
    }
}
...
elseif (isset($_POST['add_product_btn'])) {
    ...
    if($name != "" && $small_description != "" && $selling_price != "" && $qty != "" ){
    ...
    {
        redirect("add_product.php","Enter All Required Fields");
    }
}
else if(isset($_POST['update_product_btn']))
{
    ...
    {
        redirect("edit_product.php?id=$product_id", "Somethin Went Wrong!");
    }
}
